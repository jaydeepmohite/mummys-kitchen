					...
					<div class="dotted-line">
						...
						<?php 
							...
							if(isset($_SESSION['customer_email'])) {
								...
								$querry = "SELECT bill, mess_id FROM customer where customer_id = $customer_id ";
								...
								if ($ret) {
									...
									echo "<br><br><h4>Your Bill :</u>$row[0] <br></h4><br>";
									if($row[0]!=0)
									echo "<a class=acount-btn href=single_order.php?amt=$row[0]&name=$row[1]>Pay Bill</a>";
