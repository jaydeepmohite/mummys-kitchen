					...
					<div class="dotted-line">
						...
						<?php 
							...
							if(isset($_SESSION['customer_email'])) {
								...
								$querry3 = "select * from todays_menu where mess_id=$mess and date='$curr_date'";
								$ret3 = mysql_query($querry3,$conn );

								if($ret3){
									$row3 = mysql_fetch_array($ret3, MYSQL_NUM);
									$count3 =($ret3 ? mysql_affected_rows($conn): 0);	
									//echo "$count3";
									...
									if($row3){
										...
										echo "<h4><u>Today's Menu </u>: <br><br>". $row3[2] ."     Price :  " . $row3[3]. " 
											<form action=mess_details.php method=POST> 
				...
				<div class="ordering-section-grids">
					...
					<div  class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							<i class="four"></i><br>
							<i class="one-icon"></i>
							<p>View <span>Your History </span></p>
						</div>
					</div>
					<div class="clearfix"></div>
				</div>
