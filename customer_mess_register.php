	...
	<?php 
							...
							if(isset($_SESSION['customer_email'])) {
								...
								if(isset($_GET['chk'])) {
									...
									$querry = "update customer set mess_id = $name ";
									$ret  = mysql_query($querry, $conn);
									if($ret){
										echo "<h4>Mess Registration Successful!!!<br>You will be automatically redirected in 5 seconds !</h4>";
										header( "refresh:5;url=customer_mess.php" );
									}
								
								}
								else{
									
									echo "<form action='customer_mess_register.php?chk=1&name= $name&amt=$amt' method=POST>
