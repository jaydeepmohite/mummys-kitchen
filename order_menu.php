					...
					<div class="dotted-line">
						...
						<?php 
							...
							if(isset($_SESSION['customer_email'])) {
								...
								// check whether customer is registered one....
								...
								if(isset($_SESSION['menu'])) {
									...
									$querry4 = "select mess_id from customer where customer_id = $customer_id";
									$ret4 = mysql_query($querry4, $conn);
									$row4 = mysql_fetch_array($ret4,MYSQL_NUM);
									if($row4[0]!=NULL) {
										
										$querry3 = "update customer set bill = bill + $price where customer_id = $customer_id";
									...
									$querry = "insert into orders(mess_id, menu_id, customer_id, time) values ($mess, $menu, $customer_id, '$time')";
	
									$ret  = mysql_query($querry, $conn);
									
									if ($ret) {
										
										$querry2 = "select order_id from orders where mess_id=$mess and menu_id=$menu and customer_id=$customer_id and time='$time'";
										...
										if ($ret2) {
											...
											$order_id = $row2[0];
											echo "<h4>Your order will be delivered soon.<br> Order ID : $order_id<br>";
											echo "Price : $price</h4><br>";
										...
										echo "<h4>Your order is not accepted.</h4>";
									}}
									else{
