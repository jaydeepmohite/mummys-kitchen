						...
						<?php 
							...
							if(isset($_SESSION['admin_email'])) {
								...
								if ($ret) {
									...
									if($count >= 1) {
										echo "<center><h4>List of Registered Messes </h4>";
										echo "<br><table class=queries align=center border=2>";
										echo "<tr><th><p><b>Mess Name</p></th> 
										<th><p><b>Owner Name</p></th> 
										...
										echo "</table></center><br><br>";
											...
											echo "<center><h4>There are no Registered Messes yet..</h4>";
									}
								}
							}
						?>
