	...
	<div class="header">
		<div class="container">
			...
			<div class="container">
				<div class="top-menu">
					<ul>
						<li class="active"><a href="customer_homepage.php" class="scroll">Home</a></li>|
					...
					<div class="dotted-line">
						...
						if(empty($_SESSION)) {
							...
							if(isset($_SESSION['customer_email'])) {
								...
								$querry = "SELECT * FROM mess where area_name like '%$area%' ";
								...
								if ($ret) {
									...
									for($i = 0; $i < $count; $i++) {
										echo "<tr><td>$row[1]<br>$row[2]<br>$row[3]<br>$row[4]<br>$row[5]</td>";
										echo "<td><a href=mess_details.php?name=$row[0] class=acount-btn>View Mess</a></td></tr>";
										$row = mysql_fetch_array($ret, MYSQL_NUM);
									}
									echo "</table>";
									}
									else
										echo "<h4>No Messes in This Area!!!</h4>";
								}
							}		
							else{
