...
if(isset($_SESSION['customer_email'])) {
	...
	$querry = "SELECT customer_name, mobile_number, street_name, area_name, city_name, email FROM customer where customer_id = $customer_id ";
	...
	if ($ret) {
		...
		echo	"<br><br><h4><u>Customer Name :</u> {$row[0]} <br><br>". 
				"<u>Mobile Number </u>: {$row[1]} <br><br>".
				"<u>Address </u>: {$row[2]} <br><br>". 
				"{$row[3]} <br><br>". 
				"{$row[4]} <br><br>".
				"<u>Email : </u>{$row[5]}</h4>";
	} 
