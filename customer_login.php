<?php
	if(isset($_POST["submit"])){
		...
		$querry = "select * from customer where password='$password' AND email='$username' ";
	...
	<div class="container">
		<div class="login-page">
			   ...
			   <div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
				 ...
				 <a class="acount-btn" href="customer_registration.php">Create an Account</a>
			   </div>
			<?php
			...
			?>
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
				...
				<h4>Are you a mess owner? Login <b><a class="forgot" href="mess_login.php">Here</a></b></h4><br>
			    <h4>Are you the administrator? Login <b><a class="forgot" href="admin_login.php">Here</a></b></h4>
			   </div>	
			   <div class="clearfix"> </div>
			 </div>
		   </div>
