...
<body>
		...
		<div class="banner wow fadeInUp" data-wow-delay="0.4s" id="Home">
			...
			<div class="banner-info">
				<div class="banner-info-head text-center wow fadeInLeft" data-wow-delay="0.5s">
					<div class="line">
						<h2>A network of all the messes in <br>Pune City and around !!</h2>
					</div>
					<a class="acount-btn" href="#Order">Explore</a>
				</div><center>	
			</div>
		    </div>
		</div>
				...
				<div class="ordering-section-grids">
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							<i class="one"></i><br>
							<i class="one-icon"></i>
							<p>Login <span>to Mummy's Kitchen</span></p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
					...
					<div class="col-md-3 ordering-section-grid">
						<div class="ordering-section-grid-process wow fadeInRight" data-wow-delay="0.4s"">
							...
							<p>Pay   <span> online securely !</span></p>
							<label></label>
						</div>
					</div>
					<div class="col-md-3 ordering-section-grid">
	...
	<div class="footer">
		<div class="container">
			<p class="wow fadeInLeft" data-wow-delay="0.4s">&copy; 2016  All rights  Reserved | Designed & Developed by &nbsp;<a href="" target="target_blank">JDKInfoSoft.com</a></p>
		</div>
	</div>
	<!-- footer-section-ends -->
	  <script type="text/javascript">
