<?php
	if(isset($_POST["submit"])){
		...
		$querry = "select * from mess where password='$password' AND email='$email' ";
		...
		if ($ret) {
			...
			{ 
				if(empty($_SESSION)) 
					session_start();
				$_SESSION['mess_email']=$email; 
				$_SESSION['mess_id']=$row[0]; 
		...
		<div class="container">
			...
			<div class="container">
				...
				<div class="login-section">
					<ul>
						<li><a class="active" href="mess_login.php">Login</a>  </li> |
						<li><a href="mess_registration.php">Register</a> </li> |
						<li><a href="#">Help</a></li>
						<div class="clearfix"></div>
					</ul>
				</div>
	...
	<div class="container">
		<div class="login-page">
			   ...
			   <div class="col-md-6 login-left wow fadeInLeft" data-wow-delay="0.4s">
				 ...
				 <a class="acount-btn" href="mess_registration.php">Create an Account</a>
			   </div>
			   <div class="col-md-6 login-right wow fadeInRight" data-wow-delay="0.4s">
				<?php
					if(isset($_REQUEST["result"])) {
						$result = $_REQUEST["result"];	
						echo "Mess registration successful !!";
					}
	
				?>

			  	<h3>REGISTERED MESS</h3>
				<p>If you have an account with us, please log in.</p>
				<form name="mess_login" action="mess_login.php" method="POST">
				  <div>
